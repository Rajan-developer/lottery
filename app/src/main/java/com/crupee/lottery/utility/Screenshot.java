...
public class Screenshot {
    ...
    private static String saveImage(Bitmap finalBitmap, Context mContext) {
        ...
        File myDir = new File(root + "/lottery_images");
        myDir.mkdirs();

        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
        String fname = "category_name" + timeStamp + ".jpg";
    ...
    public static boolean isExternalStorageWritable() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            //Log.d("ScreenShot : ","isExternalStorageWritable ===>" + true);
            return true;
        }
        //Log.d("ScreenShot : ","isExternalStorageWritable ===>" + false);
        return false;
    }
...
//                holder.itemView.destroyDrawingCache();
    ...
    public static Bitmap getScreenshot(RecyclerView view) {

        view.measure(
                View.MeasureSpec.makeMeasureSpec(view.getWidth(), View.MeasureSpec.EXACTLY),
                View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED));

        Bitmap bm = Bitmap.createBitmap(view.getWidth(), view.getMeasuredHeight(), Bitmap.Config.ARGB_8888);
...
//            }
    ...
    public static Bitmap finalcombieimage(Bitmap c, Bitmap s, Context mContext) {
        Bitmap cs = null;

        int width = c.getWidth();
        int height = c.getHeight() + s.getHeight() + 10;
