package com.crupee.lottery.dashboard.custom_navigation;
...
import com.crupee.lottery.setting.SettingActivity;
...
public class SNavigationDrawer extends RelativeLayout {
    ...
    public static ImageView menuIV;
    public static ImageView menuSetting;
    ...
    public void init(final Context context) {
        ...
        menuSetting = rootView.findViewById(R.id.menuSetting);
